...
export default function DinoJumpFullscreen() {
  ...
  // Key to force full remount only when we want to (not between every round)
  ...
  const handleRoundEnd = useCallback(
    (_gameType: string, score: number) => {
      ...
      const thresholdHits = Math.floor(score / jumperRatio);
      const earned = thresholdHits * jumperTokensPerThreshold;
      // Always accumulate (even 0) — never block restart
      setPendingTokens((prev) => prev + earned);
      // Remount game so player can start next round immediately
      setGameKey((k) => k + 1);
    },
    [capReached, jumperRatio, jumperTokensPerThreshold],
  );
  ...
  const handleSubmit = useCallback(() => {
    ...
    const scoreEquivalent =
      jumperTokensPerThreshold > 0
        ? (pendingTokens / jumperTokensPerThreshold) * jumperRatio
        : pendingTokens * jumperRatio;

    submitScore.mutate(
      { gameType: "dino", score: BigInt(Math.round(scoreEquivalent)) },
      {
        onSuccess: (result) => {
  ...
  }, [pendingTokens, jumperRatio, jumperTokensPerThreshold, submitScore]);
  ...
  if (!isAuthenticated) {
    return (
      <div
        data-ocid="dino_fullscreen.page"
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "#120f1e", borderColor: "#3b1f6b" }}
      >
        <div className="flex items-center gap-3 min-w-0">
          <a
            href="/games"
            data-ocid="dino_fullscreen.back_link"
          ...
          <h1 className="text-sm font-bold text-foreground truncate">Jumper</h1>
          {cooldownSecs > 0 && (
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <button
            type="button"
            data-ocid="dino_fullscreen.leaderboard_toggle"
      ...
      {capReached && (
        <div
          data-ocid="dino_fullscreen.cap_reached"
      ...
      <div
        ...
        style={{ background: "#1a1230", borderColor: "#3b1f6b" }}
      >
        <div className="flex items-center gap-3 min-w-0">
          <div className="flex items-center gap-1.5 text-xs text-muted-foreground shrink-0">
            <span>
              Every {formatMIK97(jumperRatio)} pts ={" "}
              {formatMIK97(jumperTokensPerThreshold)} MIK97
            </span>
          </div>
        ...
        <button
          type="button"
          data-ocid="dino_fullscreen.submit_button"
      ...
      <div className="flex flex-1 overflow-hidden min-h-0 relative">
        ...
        <button
          type="button"
          data-ocid="dino_fullscreen.drag_handle"
        ...
        {showLeaderboard && (
          ...
          >
            ...
            >
              ...
              <button
                type="button"
                data-ocid="dino_fullscreen.leaderboard_close"
            ...
            <div className="flex-1 overflow-y-auto p-3 space-y-1.5">
              {lbLoading ? (
                ...
                <div
                  data-ocid="dino_fullscreen.leaderboard.empty_state"
